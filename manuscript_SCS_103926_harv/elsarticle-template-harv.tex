...
\multirow{2}{*}{AHP} & Sustainable development of urban areas in Lisbon & - / 6 & 10 & Subjective as determined by decision-makers & \citep{fernandes2018assessing} \\ \cline{2-6}
& Sustainable development of water reuse approaches implemented in urban settings in hypothetical medium size ''Model city'' in Israel & Economic / 1, Environmental / 3, Social / 10 & 4 & Subjective as determined by domain experts & \citep{opher2019comparative} \\
\hline
\multirow{6}{*}{MAVT} & Sustainable urban design quality and urban spaces in City of Milano & Presence and accessibility / 4, Liveability / 2, Vitality / 2, Identity and senses / 2 & 33 & Subjective as determined by domain experts & \citep{oppio2018assessing} \\ \cline{2-6}
 & Sustainability of fuel production in Europe (Rotterdam) & Economic / 1,   Environmental / 2, Social / 2 & 4 & Objective (Equal weighting) and subjective (determined by stakeholders) & \citep{ekener2018developing} \\ \cline{2-6}
 & Sustainable development supplying in heating and electricity grid-off houses in village in Portugal & Economic / 1,   Environmental / 4, Social / 2 & 4 & Subjective (SWING involving decision-makers) & \citep{gwerder2019life} \\ \cline{2-6}
 & Sustainable development of waste management in Norway & Economic / 4,   Environmental / 4, Social / 4 & 4 & Subjective as determined by stakeholders & \citep{deshpande2020multi} \\ \cline{2-6}
 & An integrated sustainability assessment of the Greek electricity system considering renewable and non-renewable energy sources & Economic / 3, Environmental / 6, Social / 6 & 7 & Objective (Equal weighting) and subjective weights provided by stakeholders & \citep{roinioti2019integrated} \\ \cline{2-6}
...
\hline
\multirow{3}{*}{TOPSIS} & Sustainable development of regions in Malta & Economic / 6,   Environmental / 6, Social / 6 & 6 & Subjective (AHP involving decision-makers) & \citep{boggia2018spatial} \\ \cline{2-6}
 & Sustainability of the heating sector in selected 7 North European   countries & Economic / 7, Environmental / 3, Social / 3 & 7 & Subjective as determined by domain experts & \citep{siksnelyte2021multi} \\ \cline{2-6}
...
\toprule
MCDA methods & Problem & Dimensions / number of criteria & Number of alternatives & Criteria weighting technique & Authors \\ \midrule
VIKOR & Sustainable   Development of Energy, Heat and Water Supply in the Philippines & Human health / 3, Employment / 1, Safety / 3, Security of supply / 3, Independence / 3, Social acceptability / 3 & 5 & Objective (Equal weighting) & \citep{aberilla2020integrated} \\
\hline
\multirow{3}{*}{SAW} & Sustainability assessment of electricity generation technologies in Egypt considering renewable and non-renewable energy sources & Technical /4, Economic / 4, Environmental / 3, Social / 2 & 7 & Subjective weights determined by stakeholders using the AHP method & \citep{shaaban2018sustainability} \\ \cline{2-6}
 & Assessment of localisations in the Besançon area in terms of sustainable urban development & Economic / 3, Environmental / 3, Social / 3 & 8 & Objective (Equal weighting) & \citep{hely2019combining} \\ \cline{2-6}
 & Sustainability Assessment of Energy system transformation scenarios in Germany & Ecological / 16, Socio-economic / 6, Socio-technical / 1 & 10 & Discrete Choice Experiments and Focus Groups & \citep{naegler2021integrated} \\
\hline
\multirow{2}{*}{SMARTER} & Sustainability assessment of electricity generation technologies in Bangladesh & Economic / 5, Environmental / 4, Social / 10 & 8 & Subjective weights determined by decision-maker & \citep{khan2019power} \\ \cline{2-6}
 & Sustainable   development of infrastructure generating electricity in South Asia Growth Quadrangle (SAGQ): Bangladesh, Bhutan, India, Nepal & Economic / 4, Environmental / 4, Social / 34 & 9 & Subjective as determined by decision-makers & \citep{khan2020sustainability} \\
\hline
\multirow{2}{*}{PROMETHEE} & Sustainability of logistics strategies on the example of a food company cooperative and a logistics service provider in Austria & Economic / 4, Environmental / 2, Technological / 2, Social / 2 & 3 & Subjective (SWING involving decision-makers) & \citep{melkonyan2020sustainability} \\ \cline{2-6}
...
$C_{1}$ & Overcrowding rate by poverty status & \% of population & Minimize & Economic & SDG\#11.1 SDG\#11.7 SDG\#11.a   SDG\#11.b & \citep{huovila2019comparative}, \citep{phillis2017urban} \\
$C_{2}$ & Population living in households considering that they suffer from noise,   by poverty status & \% of population & Minimize & Environmental & SDG\#11.1 & \citep{huovila2019comparative}, \citep{phillis2017urban} \\
$C_{3}$ & Settlement area per capita & $m^2$ per capita & Maximize & Economic & SDG\#11.3 SDG\#11.a SDG\#11.b & \citep{phillis2017urban}, \citep{yi2019evaluation} \\
$C_{4}$ & People killed in road accidents & Rate (persons and number per 100 000 persons) & Minimize & Social & SDG\#11.2 & \citep{huovila2019comparative}, \citep{phillis2017urban} \\
$C_{5}$ & Exposure to air pollution by particulate matter & $\mu g / m^3$ & Minimize & Environmental & SDG\#11.4 SDG\#11.5 & \citep{phillis2017urban}, \citep{yi2019evaluation} \\
$C_{6}$ & Recycling rate of municipal waste & \% of total waste generated & Maximize & Environmental & SDG\#11.6 & \citep{huovila2019comparative}, \citep{chen2020evaluation}, \citep{phillis2017urban} \\
$C_{7}$ & Population living in a dwelling with a leaking roof, damp walls, floors   or foundation or rot in window frames of floor by poverty status & \% of population & Minimize & Economic & SDG\#11.c & \citep{huovila2019comparative}, \citep{phillis2017urban} \\
$C_{8}$ & Population connected to at least secondary waste water treatment & \% of population & Maximize & Environmental & SDG\#11.6 & \citep{huovila2019comparative}, \citep{yi2019evaluation} \\
$C_{9}$ & Share of buses and trains in total passenger transport & \% of total inland passenger-km & Maximize & Social & SDG\#11.2 & \citep{huovila2019comparative}, \citep{chen2020evaluation}, \citep{phillis2017urban} \\
$C_{10}$ & Population reporting occurrence of crime, violence or vandalism in their   area by poverty status & \% of population & Minimize & Social & SDG\#11.1 SDG\#11.7 & \citep{huovila2019comparative}, \citep{phillis2017urban} \\ \bottomrule
\end{tabular}
}
\end{table*}
...
\end{table}
%
Deterioration for social criteria $C_{9}$ and $C_{10}$ contributed to the fact that the United Kingdom's overall evaluation using the DARIA-TOPSIS method in the social dimension was in the penultimate place. However, in the economic dimension, it is fifteenth, and in the environmental dimension tenth.
%
% United Kingdom
\begin{table}[H]
\centering
...
\centering
\quad
\subfloat[][VIKOR]{\includegraphics[width=0.5\linewidth]{radar_vikor.eps}}
\subfloat[][COMET]{\includegraphics[width=0.5\linewidth]{radar_comet.eps}}
...
\centering
\quad
\subfloat[][2015]{\includegraphics[width=0.25\linewidth]{pearson_2015.eps}}
